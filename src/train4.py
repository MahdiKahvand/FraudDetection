...
print(
    total_result_table.round(4).to_string(
        index=False
    )
)
...
# ============================================================
# 11. Cross Validation Result Table
# ============================================================
...
cv_result_table = cv_result_table.round(
    4
)


print(
    "\n========== 5-Fold Average Result ==========\n"
)

print(
    cv_result_table.to_string(
        index=False
    )
)
