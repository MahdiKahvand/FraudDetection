...
# ============================================================
# 9. total result and compare
# ============================================================
model_name_list = ["logestic regression" ,"KNN" ,"Decisioon Tree","MLP"]

accuracy_total_list = [acc_default_LRC , acc_default_KNN ,acc_default_DTC ,acc_default_MLP]

precision_total_list = [precision_default_LRC ,precision_default_KNN ,precision_default_DTC ,precision_default_MLP]

recall_total_list = [recall_default_LRC ,recall_default_KNN ,recall_default_DTC ,recall_default_MLP]

f1_total_list = [f1_default_LRC ,f1_default_KNN ,f1_default_DTC ,f1_default_MLP]

total_result_tabel = pd.DataFrame({"Model":model_name_list ,
